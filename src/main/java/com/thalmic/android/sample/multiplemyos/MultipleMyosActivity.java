...
public class MultipleMyosActivity extends Activity {
    ...
    private DeviceListener mListener = new AbstractDeviceListener() {
        ...
        public void onPose(Myo myo, long timestamp, Pose pose) {
            ...
            if (mKnownMyos.size() == 2 && !mCalibrated) {
                Intent intent = new Intent(MultipleMyosActivity.this, FingerActivity.class);
                //MyoConnection conn = new MyoConnection(mKnownMyos);
                //intent.putExtra("knownMyos", conn);
